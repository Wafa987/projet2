...
import { FaRegStar, FaStar, FaSearch, FaTrash } from 'react-icons/fa';
  ...
  return (
    <div className="rounded">
      <table cellSpacing={2} cellPadding={5} border={1} className="border-collapse table-fixed w-full text-sm bg-white text-left">
        <thead>
          <th colSpan={0} className="py-2 px-4 font-semibold text-gray-200 bg-gray-200 "><FaStar className="text-gray-600 text-sm"></FaStar></th>
