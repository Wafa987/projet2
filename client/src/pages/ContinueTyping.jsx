    ...
    <div className="text-left">
      <form className="bg-white rounded px-8 pt-6 pb-8 mb-4 mx-auto w-full">
        <div className="w-1/2">
          <label className="block text-gray-700 text-sm mb-2">
            Destination
            <input name="email_receiver" value={formData.email_receiver} onChange={onFormChange} className="mt-3 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="email" placeholder="e-mail_receiver" />
            {formErrors.email_receiver && <span className="text-red-600">{formErrors.email_receiver}</span>}
          </label>
        </div>
        <div className="w-1/2">
          <label className="block text-gray-700 text-sm mb-2">
            CC
            <input name="cc" value={formData.cc} onChange={onFormChange} className="mt-3 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="email" placeholder="e-mail_receiver" />
            {formErrors.cc && <span className="text-red-600">{formErrors.cc}</span>}
          </label>
        </div>
        <div className="w-1/2">
          <label className="block text-gray-700 text-sm mb-2">
            Subject
            <input name="subject" value={formData.subject} onChange={onFormChange} className="mt-3 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="subject" />
            {formErrors.subject && <span className="text-red-600">{formErrors.subject}</span>}
          </label>
        </div>
        <div>
          <label className="block text-gray-700 text-sm mb-4">
            Content
            <textarea name="content" value={formData.content} onChange={onFormChange} rows="10" className="mt-3 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-auto" placeholder="content"></textarea>
            {formErrors.content && <span className="text-red-600">{formErrors.content}</span>}
          </label>
        </div>
        <div>
